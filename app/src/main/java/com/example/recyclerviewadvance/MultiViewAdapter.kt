...
class MultiViewAdapter(private val context: Context, private val listViewType: List<Int>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ITEM_HEADER_VIEW -> ViewHolderText(inflater.inflate(R.layout.item_text_only, parent, false))
            ITEM_OFFER_VIEW -> ViewHolderImage(inflater.inflate(R.layout.item_image_offer, parent, false))
            ITEM_RESTAURANT_VIEW -> ViewHolderImageText(inflater.inflate(R.layout.item_text_offer, parent, false))
...
//if (position == 1) R.drawable.zomato3 else R.drawable.zomato1
//if (position == 2) R.drawable.zomato2 else R.drawable.zomato3