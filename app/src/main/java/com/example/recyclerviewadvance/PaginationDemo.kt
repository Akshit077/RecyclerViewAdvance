...
class PaginationActivity : AppCompatActivity() {
    ...
    private lateinit var multiViewRecyclerAdapter: MultiViewAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiViewRecyclerAdapter = MultiViewAdapter(this, listViewType2)
    ...
    private fun addDataInList(){
        ...
        for (i in start..end) {
            when {
                i % 2 == 0 -> {
                    listViewType2.add(MultiViewAdapter.ITEM_HEADER_VIEW)
                }
                i % 3 == 0 -> {
                    listViewType2.add(MultiViewAdapter.ITEM_OFFER_VIEW)
                }
                else -> {
                    listViewType2.add(MultiViewAdapter.ITEM_RESTAURANT_VIEW)
                }
            }
        }
    }
